			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				if ($row['coin_type'] == "BTC") {
					if ($row['btc_address'] == "none") {
						$addressy = 'Network Problem contact: support@primewealthhorizon.com';
					} else {
						$addressy = @$row['btc_address'];
					}
				} else if ($row['coin_type'] == "ETH") {
					if ($row['ethereum_address'] == "none") {
						$addressy = 'Network Proble contact: support@primewealthhorizon.com';
					} else {
...
you already made payment. Have any problem? Contact us @ support@primewealthhorizon.com</td>
								 </tr>'*/;
				} else {
					$add = '';
				}
