...
if (isset($_POST['sub'])) {
        ...
        if (!empty($fname) && !empty($lname)) {
                ...
                if (!empty($pass)) {
                        if ($pass == $cpass) {
                                $feilds = array('fname', 'lname', 'phone',  'password', 'forget_password_code', 'two_factor_code', 'date_created', 'hashed_pot', 'bank_routing_number', 'bank_name', 'account_number', 'account_name', 'id_type', 'affilaite_url', 'twitter_url', 'youtube_url', 'instagram_url', 'facebook_url', 'linkedin_url', 'address', 'country', 'short_bio', 'sex', 'rawpass', 'pin');
                                $value = array($fname, $lname, $phone, $passh, $forget_password_code, $two_factor_code, $date_created, $hashed_pot, $bank_routing_number, $bank_name, $account_number, $account_name,  $id_type, $affilaite_url, $twitter_url, $youtube_url, $instagram_url, $facebook_url, $linkedin_url, $address, $country, $short_bio, $sex, $rawpass, $pin);
                        } else {
                     ...
                     id="formFile1" multiple>-->
                                                                                                                                                ...
                                                                                                                                                <div class="col-6">
                                                                                                                                                        <div class="input-box">
                                                                                                                                                                ...
                                                                                                                                                                <select class="js-example-basic-single w-100" name="id_document_status" disabled>
                                                                                                                        ...
                                                                                                                        <div>
                                                                                                                                ...
                                                                                                                                <div class="input-items">
                                                                                                                                        <div class="row gy-3 mb-4">
                                                                                                                                                ...
                                                                                                                                                <div class="col-6">
                                                                                                                                                        <div class="input-box">
                                                                                                                                                                <h6>Routing Number(If applicable)</h6>
