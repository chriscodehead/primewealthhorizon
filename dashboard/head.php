<head>
 ...
 <meta name="description"
  content="At PRIME WEALTH HORIZON, we are dedicated to helping individuals and businesses achieve their full potential.">
 <meta name="keywords"
  content="admin, admin template, dashboard template, flat admin template, responsive admin template, web app">
