            ...
            <div class="page-body">
                                                        ...
                                                        while ($row = mysqli_fetch_assoc($sql)) { ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <ul>
                                                                        <li>
                                                                            <a href="edit-product?product-id=<?php print $row['product_id']; ?>">
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="button" onclick="delProduct('<?php print $row['product_id']; ?>')" id="delProduct" class="btn btn-animation btn-md fw-bold" data-bs-dismiss="modal">Yes <i id="spin" class=""></i></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                ...
                <script>
                    function delProduct(p_id) {
                        ...
                        var url = "ajax-call.php?action=deleteProduct";
                        var productId = p_id;
