 <footer class="ak-footer style-1 fixed-footer footer-bg">
   ...
   <div class="ak-footer-container">
     ...
     <div class="container">
       <div class="footer-content">
         <div class="company-info">
           <a class="ak-site_branding" href="index-2.html">
           ...
           <div class="social-icon">
             <a href="<?php print $siteFacebook; ?>" class="icon">
               <svg
                 width="9"
                 height="15"
                 viewBox="0 0 9 15"
             ...
             <a href="<?php print $siteLinkedin; ?>" class="icon">
               <svg
                 height="15"
                 viewBox="0 0 128 128"
                 width="15"
             ...
             <a href="<?php print $siteInstagram; ?>" class="icon">
               <svg
                 width="15"
                 height="15"
                 viewBox="0 0 15 15"
             ...
             <a href="<?php print $sitetwitter; ?>" class="icon">
               <svg
                 width="15"
                 height="15"
                 viewBox="0 0 15 15"
         ...
         <div class="footer-nav">
           <div class="new-letter-email">

           </div>
           <div class="footer-link">
             <div class="link-content">
               <h5 class="short-title">About Us</h5>
               <ul class="linek-all">
                 <li><a href="./">Home</a></li>
             ...
             <div class="link-content">
               <h5 class="short-title">Services</h5>
               <ul class="linek-all">
                 <li><a href="service">Services</a></li>
                 <li><a target="_blank" href="<?php print $siteCalender; ?>">Consultation</a></li>
                 <li><a href="terms">Terms and Conditions</a></li>
                 <li><a href="policy">Privacy Policy</a></li>
               </ul>
             </div>
             <div class="link-content">
               <h5 class="short-title">Get In Touch</h5>
               <ul class="linek-all">
                 <li>
                   <a href="https://www.google.com/maps" class="mb-3"><?php print $siteAddress; ?></a>
                 </li>
                 <li>
                   <a href="tel:<?php print $sitePhone; ?>" class="mb-3"><span class="ak-font-20">Phone: </span><br />
                     <?php print $sitePhone; ?></a>
                 </li>
                 <li>
                   <a href="mailto:<?php print $siteEmail; ?>"><span class="ak-font-20">Email: </span>
                     <br />
                     <?php print $siteEmail; ?></a>
                 </li>
               </ul>
             </div>
           </div>
     ...
     <div class=" ak-height-lg-50"></div>
   </div>
   <div class="copy-right">
     <p class="copyright-text">
       Copyright <?php print $siteYear; ?> <?php print $siteName; ?>, All Rights Reserved. Dev by <a href="https://centadesk.com">Centadesk</a>
     </p>
   </div>
 </footer>
