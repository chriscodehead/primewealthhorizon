            ...
            <table width="100%" border="0" cellspacing="0"
                ...
                <tr>
                    <td class="img m-center"
                        ...
                        <img src="https://primewealthhorizon.com/img/logo.png"
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td class="img" width="55"
                        ...
                        <a href="#" target="_blank"><img
                                src="https://primewealthhorizon.com/mail_images/ico_facebook.jpg"
                    ...
                    <td class="img" width="55"
                        style="font-size:0pt; line-height:0pt; text-align:left;">
                        <a href="#" target="_blank"><img
                                src="https://primewealthhorizon.com/mail_images/ico_twitter.jpg"
                                width="38" height="38" border="0"
                                alt="" /></a>
                    </td>
                    <td class="img" width="55"
                        style="font-size:0pt; line-height:0pt; text-align:left;">
                        <a href="#" target="_blank"><img
                                src="https://primewealthhorizon.com/mail_images/ico_instagram.jpg"
                                width="38" height="38" border="0"
                                alt="" /></a>
                    </td>
                    <td class="img" width="38"
                        style="font-size:0pt; line-height:0pt; text-align:left;">
                        <a href="#" target="_blank"><img
                                src="https://primewealthhorizon.com/mail_images/ico_linkedin.jpg"
                                width="38" height="38" border="0"
                                alt="" /></a>
                    </td>
                </tr>
    ...
    <tr>
        <td class="text-footer1 pb10"
            ...
            Email:info@primewealthhorizon.com, support@primewealthhorizon.com
...
from this mailing list.
    ...
    ';
        $header = "MIME-Version: 1.0" . "\r\n";
        $header .= "Content-type:text/html;charset=UTF-8" . "\r\n";
        $header .= 'From: NETZONE META TRADING <support@primewealthhorizon.com>' . "\r\n";
        $retval = @mail($to, $subject, $message, $header);
